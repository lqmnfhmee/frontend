...
export default function RbiVesselListPage() {
    ...
    return (
        <div className="space-y-6">
            {/* 🔹 PAGE HEADER */}
            <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Vessel Assessment</h1>
            </div>
                            ...
                            {filteredVessels.map((vessel) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        <span className={`inline-flex items-center justify-center w-8 h-8 rounded-full border text-xs font-bold ${vessel.risk === 'C1' ? 'border-blue-300 text-blue-600 bg-blue-50' :
                                                vessel.risk === 'B1' ? 'border-blue-300 text-blue-600 bg-blue-50' :
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end gap-2 opacity-100 transition-opacity">
                                            <Link
                                                href={`/rbi/vessel/${vessel.tag.toLowerCase()}`}
