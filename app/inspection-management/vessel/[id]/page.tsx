...
import VesselPropertiesTab from "@/app/inspection-management/vessel/[id]/components/VesselPropertiesTab";
import VesselInspectionTab from "@/app/inspection-management/vessel/[id]/components/VesselInspectionTab";
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
                <Link
                    href="/inspection-management/vessel"
                ...
                <div>
                    <div className="flex items-center gap-3">
                        <h1 className="text-xl font-bold text-slate-900 dark:text-white uppercase">
                            VESSEL, PRODUCTION SEPARATOR, 1V-210
                        </h1>
                ...
                <div className="bg-white dark:bg-[var(--color-brand-darkCard)] rounded-xl border border-slate-200 dark:border-[var(--color-brand-darkBorder)] shadow-sm p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                        <div className="sm:col-span-2">
                            ...
                            <p className="text-sm font-medium text-slate-900 dark:text-white">VESSEL, PRODUCTION SEPARATOR, 1V-210</p>
                        </div>
                        <div>
                            <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">Asset Tag</p>
                            <p className="text-sm font-medium text-slate-900 dark:text-white">1V-210</p>
                        </div>
                        <div>
                ...
                <div className="bg-white dark:bg-[var(--color-brand-darkCard)] rounded-xl border border-slate-200 dark:border-[var(--color-brand-darkBorder)] shadow-sm p-4 md:p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-slate-900 dark:text-white uppercase">CRUDE SEPARATION UNIT</p>
                        </div>
                        <div>
                            <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">Package</p>
                            <p className="text-sm font-medium text-slate-900 dark:text-white uppercase">PRODUCTION SEPARATOR, 1V-210</p>
                        </div>
                        <div>
            ...
            {/* 🔹 TABS */}
            <div className="bg-white dark:bg-[var(--color-brand-darkCard)] rounded-xl border border-slate-200 dark:border-[var(--color-brand-darkBorder)] shadow-sm p-1.5 flex gap-1">
                <button
            ...
            {/* 🔹 TAB CONTENT */}
            {activeTab === "properties" && <VesselPropertiesTab />}
            {activeTab === "inspection" && <VesselInspectionTab />}
        </div>
    );
}
