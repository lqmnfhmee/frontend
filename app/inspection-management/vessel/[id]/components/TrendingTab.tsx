        ...
        <div className="space-y-6 animate-in fade-in duration-300">
                ...
                <div className="space-y-6 animate-in fade-in duration-300">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                        <div className="p-6 border-b border-slate-200 dark:border-slate-800">
                            <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
                                Calculation Summary - 1V-210_NZL N1 / TML-N1-Clock 0 Deg
                            </h3>
                        </div>
            ...
            {activeTab === "degradation" && (
                <div className="space-y-6 animate-in fade-in duration-300">
                    ...
                    {[
                        {
                            group: "1V-210_DRUM Head",
                            points: [
                                { id: "TML-HA1-Clock 0 Deg", thick: "49.63", stcr: "0.2194", ltcr: "0.0124" },
                                { id: "TML-HA1-Clock 180 Deg", thick: "44.95", stcr: "-0.2855", ltcr: "-0.2855" },
                                { id: "TML-HA1-Clock 270 Deg", thick: "50.18", stcr: "0.0810", ltcr: "0.0810" },
                                { id: "TML-HA1-Clock 90 Deg", thick: "54.76", stcr: "-0.1573", ltcr: "-0.1573" },
                                { id: "TML-HB1-Clock 0 Deg", thick: "42.72", stcr: "0.3600", ltcr: "0.3600" },
                                { id: "TML-HB1-Clock 180 Deg", thick: "41.97", stcr: "0.4058", ltcr: "0.4058" },
                            ]
                        },
                        {
                            group: "1V-210_DRUM Manway",
                            points: [
                                { id: "TML-MW1-Clock 0 Deg", thick: "135.80", stcr: "0.4880", ltcr: "0.4880" },
                                { id: "TML-MW1-Clock 180 Deg", thick: "127.46", stcr: "0.0706", ltcr: "0.0706" },
                                { id: "TML-MW1-Clock 270 Deg", thick: "127.67", stcr: "0.1224", ltcr: "0.1224" },
                                { id: "TML-MW1-Clock 90 Deg", thick: "127.44", stcr: "0.2110", ltcr: "0.2110" },
                                { id: "TML-MW2-Clock 0 Deg", thick: "139.42", stcr: "0.6348", ltcr: "0.6348" },
                            ]
                        },
                        {
                            group: "1V-210_DRUM Shell",
                            points: [
                                { id: "TML-SA-Clock 0 Deg", thick: "52.07", stcr: "-0.0405", ltcr: "-0.0405" },
                                { id: "TML-SA-Clock 180 Deg", thick: "55.31", stcr: "-0.1062", ltcr: "-0.1062" },
                                { id: "TML-SA-Clock 270 Deg", thick: "58.01", stcr: "-0.0041", ltcr: "-0.0041" },
                                { id: "TML-SA-Clock 90 Deg", thick: "56.05", stcr: "0.1491", ltcr: "0.1491" },
                            ]
                        }
                    ].map(section => (
