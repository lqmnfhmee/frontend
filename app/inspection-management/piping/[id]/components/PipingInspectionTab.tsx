...
import TrendingTab from "@/app/inspection-management/piping/[id]/components/TrendingTab";
import AnomaliesTab from "@/app/inspection-management/piping/[id]/components/AnomaliesTab";
import AttachmentsTab from "@/app/inspection-management/piping/[id]/components/AttachmentsTab";
...
const COMPONENTS = [
    { name: "PIPE01_SEG 01", nominal: "12.70", required: "11.10", cml: "2" },
    { name: "PIPE01_SEG 02", nominal: "12.70", required: "11.10", cml: "3" },
    { name: "PIPE01_VALVE V1", nominal: "25.40", required: "22.00", cml: "1" },
    { name: "PIPE01_VALVE V2", nominal: "25.40", required: "22.00", cml: "1" },
    { name: "PIPE01_ELBOW E1", nominal: "18.50", required: "16.00", cml: "4" },
    { name: "PIPE01_TEE T1", nominal: "18.50", required: "16.00", cml: "2" },
];

const INSPECTION_TASKS = [
    { checksheet: "LRA-INSP-2026-0045", title: "May 2025", type: "UTTM", plannedStart: "May 10, 2025", status: "Completed" },
    { checksheet: "LRA-INSP-2026-0030", title: "December 2023", type: "Visual", plannedStart: "Dec 5, 2023", status: "Completed" },
];

export default function PipingInspectionTab() {
    ...
    return (
        <div className="space-y-6">
            ...
            {activeSubTab === "properties" && (
                <div className="space-y-6 animate-in fade-in duration-300">
                    <div className="bg-white dark:bg-[var(--color-brand-darkCard)] rounded-xl border border-slate-200 dark:border-[var(--color-brand-darkBorder)] shadow-sm p-4 md:p-6 space-y-4 md:space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 pt-4 border-t border-slate-200 dark:border-[var(--color-brand-darkBorder)]">
                            <div>
                                <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">Elevation (m)</p>
                                <p className="text-sm font-medium text-slate-900 dark:text-white">15m</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-slate-900 dark:text-white">Requires Scaffolding</p>
                            </div>
                            <div>
                                <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">Anomaly</p>
                                <p className="text-sm font-medium text-slate-900 dark:text-white">No</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-[var(--color-brand-darkCard)] rounded-xl border border-slate-200 dark:border-[var(--color-brand-darkBorder)] shadow-sm overflow-hidden flex flex-col">
                        <div className="p-4 border-b border-slate-200 dark:border-[var(--color-brand-darkBorder)] flex items-center gap-2 text-slate-900 dark:text-white font-medium bg-slate-50/50 dark:bg-[var(--color-brand-darkCard)]/50">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5 opacity-70">
                        ...
                        <div className="p-4 border-t border-slate-200 dark:border-[var(--color-brand-darkBorder)] flex items-center justify-between text-sm text-slate-500 dark:text-slate-400 bg-white dark:bg-[var(--color-brand-darkCard)]">
                            <span className="opacity-0">Filler</span>
                        </div>
                    </div>
                </div>
            )}
            ...
            {/* 🔹 TASKS SUB-TAB */}
            {activeSubTab === "tasks" && (
                <div className="bg-white dark:bg-[var(--color-brand-darkCard)] rounded-xl border border-slate-200 dark:border-[var(--color-brand-darkBorder)] shadow-sm overflow-hidden animate-in fade-in duration-300">
                    <div className="p-6 border-b border-slate-200 dark:border-[var(--color-brand-darkBorder)] flex items-center justify-between">
